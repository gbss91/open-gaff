...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary h-16" data-testid="nav-container">
      <div
        className="max-w-full flex items-center justify-between mx-auto px-4 h-full"
      ...
      >
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-1 w-8 h-8 justify-center text-sm text-accent rounded-lg md:hidde focus:outline-none"
